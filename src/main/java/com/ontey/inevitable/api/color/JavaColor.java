package com.ontey.inevitable.api.color;

import com.ontey.inevitable.api.regstr.RegStr;
...
public class JavaColor {
   ...
   public static String direct(int r, int g, int b) {
      return of(r, g, b).toString();
   }
   
   public static JavaColor of(int r, int g, int b) {
      return foreground(r, g, b);
   }
   
   public static JavaColor foreground(int r, int g, int b) {
      return new JavaColor(r, g, b);
   }
   
   public static JavaColor background(int r, int g, int b) {
      return new JavaColor(r, g, b);
   }
   ...
   public static String colorize(String str) {
      ...
      str = new RegStr(str).replaceAll("<(\\d{1,3}),(\\d{1,3}),(\\d{1,3})>", "$1,$2,$3", grp -> {
      ...
      str = new RegStr(str).replaceAll("<([a-zA-Z_]+)>", "$1", grp ->
