...
public class Command {
   ...
   // should only be called in registration -> has at least one name
   ...
   public void register() {
      ...
      Objects.requireNonNull(root, "The root hasn't been set at registration");
